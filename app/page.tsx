...
export default function HomePage() {
  ...
  // Get 4 most recent products for featured section
  const featured = [...products]
    .sort((a, b) => b.id - a.id) // recent first (you can use createdAt instead)
    .slice(0, 4);

  // Limit to 12 most recent filtered products
  const latestFiltered = [...filtered]
